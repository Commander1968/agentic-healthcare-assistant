...
def evaluate_response_precision(
    *,
    ...
    formula = (
        f"{len(supported)} / {verifiable_count} = "
        f"{precision:.2%}"
    ...
    return ResponsePrecisionResult(
        ...
        formula=formula,
        evaluation_basis=(
            "Claim-level supported-claim precision: "
            "supported verifiable claims divided by total verifiable claims. "
            "Conversational or unverifiable text is excluded."
        ),
